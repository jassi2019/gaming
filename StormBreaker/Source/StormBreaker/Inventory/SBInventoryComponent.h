...
public:
    ...
    UPROPERTY(EditDefaultsOnly, Category = "StormBreaker|Inventory")
    ...
    UFUNCTION(BlueprintCallable, Category = "StormBreaker|Inventory")
    ...
    UFUNCTION(BlueprintPure, Category = "StormBreaker|Inventory")
    ...
    UFUNCTION(BlueprintCallable, Category = "StormBreaker|Equipment")
    bool EquipArmor(const FName& ItemID);

    UFUNCTION(BlueprintCallable, Category = "StormBreaker|Equipment")
    void UnequipArmor(ESBArmorSlot Slot);

    UFUNCTION(BlueprintPure, Category = "StormBreaker|Equipment")
    ...
    UFUNCTION(BlueprintCallable, Category = "StormBreaker|Consumable")
    bool UseConsumable(const FName& ItemID);

    UFUNCTION(BlueprintCallable, Category = "StormBreaker|Consumable")
    void CancelConsumable();

    UFUNCTION(BlueprintPure, Category = "StormBreaker|Consumable")
    ...
    UFUNCTION(BlueprintPure, Category = "StormBreaker|Boost")
    const FSBBoostState& GetBoostState() const { return BoostState; }

    // --- Auto Loot Settings ---

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "StormBreaker|AutoLoot")
    ...
    UFUNCTION(BlueprintPure, Category = "StormBreaker|AutoLoot")
